!(function () {
                    ...
                    ? null !== (t = document.querySelector("#" + e)) &&
                      ...
                      1 == document.getElementById("layout-direction-ltr").checked && "layout-direction-ltr" === t
                          ? (document.getElementsByTagName("html")[0].removeAttribute("dir"),
                            ...
                            document.getElementById("bootstrap-style").setAttribute("href", "../resources/css/bootstrap.min.css"),
                            document.getElementById("app-style").setAttribute("href", "../resources/css/app.min.css"),
    ...
    [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function (e) {
        ...
        "null" != t && t !== a && n(t),
        (u = document.getElementsByClassName("language")) && u.forEach(function (t) {
        ...
        (c = document.getElementsByTagName("body")[0]).hasAttribute("data-layout") && "horizontal" == c.getAttribute("data-layout")
            ...
            : r("layout-vertical"),
        c.hasAttribute("data-bs-theme") && "dark" == c.getAttribute("data-bs-theme") ? r("layout-mode-dark") : r("layout-mode-light"),
