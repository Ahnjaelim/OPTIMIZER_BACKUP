...
public class UserController {
	...
	/** 안재림 2024.08.13 **/
	@RequestMapping(value = "/updateUserStep", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateUserStep(HttpServletRequest request, UserVO userVO) {
		HttpSession session = request.getSession();
		UserVO sessioninfo = (UserVO) session.getAttribute("login");
		ArrayList<Integer> site_list = (ArrayList<Integer>) session.getAttribute("SiteList");
        // optimizerVO.setSite_list(site_list);
		
        int data = userService.updateUserStep(userVO);
	...
	/** 안재림 2024.08.13 **/
	@RequestMapping(value = "/selectUserBySn", method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> selectUserBySn(HttpServletRequest request, UserVO userVO) {
		HttpSession session = request.getSession();
		UserVO sessioninfo = (UserVO) session.getAttribute("login");
		ArrayList<Integer> site_list = (ArrayList<Integer>) session.getAttribute("SiteList");
        // optimizerVO.setSite_list(site_list);
		
        UserVO data = userService.selectUserBySn(userVO);
